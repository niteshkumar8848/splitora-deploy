    ...
    <footer className="mt-12 border-t border-border/70 bg-white/70 backdrop-blur-md">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 flex flex-col md:flex-row gap-6 md:items-center md:justify-between">
        ...
        <div className="flex items-center gap-4 text-sm">
          ...
          <a className="text-muted-foreground hover:text-foreground transition-colors" href="https://render.com" target="_blank" rel="noreferrer">
            Render
          </a>
          <a className="text-muted-foreground hover:text-foreground transition-colors" href="https://vercel.com" target="_blank" rel="noreferrer">
            Vercel
          </a>
        </div>
      </div>
